        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:px-12">
          ...
          <div className="flex gap-2">
            ...
            {project.youtubeShorts && (
              <a
                href={`https://youtube.com/shorts/${project.youtubeShorts}`}
                target="_blank"
                rel="noreferrer"
            ...
            {project.githubUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-full bg-[#24292f] px-5 py-2 text-sm font-bold text-white"
              >
                GitHub
              </a>
            )}
            ...
            {project.wikiUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-full bg-[#6b5b95] px-5 py-2 text-sm font-bold text-white"
              >
                Wiki
              </a>
            )}
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 pt-32 md:px-12">
        <div className="grid items-start gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          <div className="lg:sticky lg:top-28">
            ...
            <p className="mt-6 text-lg leading-9 text-[#59616d]">
              {project.desc}
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {project.tags.map((tag) => (
                <span
                  key={tag}
                  className="rounded-full bg-white px-3 py-1 text-xs font-bold text-[#59616d]"
                >
                  {tag}
                </span>
              ))}
