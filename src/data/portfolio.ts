  ...
  aiWorkflow: [
    {
      ...
      role: "기획자 에이전트",
      detail:
        "시장의 Pain Point 정의, 사용자 흐름(User Flow) 설계, MVP 기능 범위 획정",
    },
    {
      num: "02",
      role: "풀스택 개발자 에이전트",
      detail:
        "Flutter/React 코드 아키텍처 설계, Firebase 및 백엔드 인프라 구축, 알고리즘 구현",
    },
    {
      num: "03",
      role: "하이퍼 디버거 에이전트",
      detail:
        "빌드/타입/클라우드 배포 오류 추적, 모바일 WebView 및 PWA 환경별 이슈 실시간 대응",
    },
    {
      num: "04",
      role: "UI/UX 디자이너 에이전트",
      detail:
        "컴포넌트 화면 구성 가이드, 게임 캐릭터 에셋 기획, 요리 카드·마케팅 리워드 디자인 조율",
    },
    {
      num: "05",
      role: "사업전략 에이전트",
      detail:
        "비즈니스 모델 정교화, 정부 지원 사업계획서 공략 문항 정리, 투자 유치용 피치덱 구성",
    },
    {
      num: "06",
      role: "특허출원 에이전트",
      detail:
        "AI와 명세서를 작성해 직접 출원. '특허로' 온라인 접수와 70% 감면을 활용해 낮은 비용으로 특허출원",
    },
  ],
};
...
export const projectsData = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Sanghyug/naezzal4zzal-web",
    wikiUrl: "https://github.com/Sanghyug/naezzal4zzal-web/wiki",
    slug: "naezzal4zzal",
  ...
  },
  {
    ...
    youtubeShorts: "GzvrMSzJCA4",
    liveUrl: "https://mom-is-flower.vercel.app",
    githubUrl: "https://github.com/Sanghyug/mom-is-flower-app",
    wikiUrl: "https://github.com/Sanghyug/mom-is-flower-app/wiki",
    slug: "mom-is-flower",
